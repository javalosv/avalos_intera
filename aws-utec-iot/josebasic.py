    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            if mode == 'both' or mode == 'publish':
                message = {}
                message['head'] = self.pub_msg[0]
                message['right_j0'] = self.pub_msg[1]
                message['right_j1'] = self.pub_msg[2]
                message['right_j2'] = self.pub_msg[3]
                message['right_j3'] = self.pub_msg[4]
                message['right_j4'] = self.pub_msg[5]
                message['right_j5'] = self.pub_msg[6]
                message['right_j6'] = self.pub_msg[7]
...
if __name__ == '__main__':
    ...
    try:
        rospy.init_node('node_mqtt', anonymous=True)
        send=SendIOT()
        print("begin send... ")
